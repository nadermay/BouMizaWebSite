/**
 * Contact / Nous Trouver Page — Full location, map, and contact form
 */
export function renderContact(container, { currentLang, t }) {
  container.innerHTML = `
          ...
          <div class="contact-info-block">
            ...
            <div class="contact-socials" style="display: flex; gap: 10px; flex-wrap: wrap; margin-top: 20px;">
              ${(() => {
                ...
                return `
                  <a href="https://wa.me/21651648574?text=Bonjour%20Boumiza%20Square%2C%20j%27aimerais%20avoir%20plus%20d%27informations." target="_blank" rel="noopener" class="social-pill social-pill--lg" style="color: #25D366; border-color: #25D366">${waSvg} WhatsApp</a>
                  <a href="https://www.facebook.com/profile.php?id=61563502731837" target="_blank" rel="noopener" class="social-pill social-pill--lg">${fbSvg} Facebook</a>
                  <a href="https://www.instagram.com/boumiza__square/" target="_blank" rel="noopener" class="social-pill social-pill--lg">${igSvg} Instagram</a>
                  <a href="https://www.tiktok.com/@boumiza.square" target="_blank" rel="noopener" class="social-pill social-pill--lg">${tkSvg} TikTok</a>
                `;
              })()}
            </div>
          </div>
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      setTimeout(() => {
        btn.textContent = t('contact.formSend');
